...
<script type="text/javascript">
	function result(zipNum, sido, gugun, dong) { //주소 조합해서 회원가입폼으로 보냄. 서울+시+노원+구+중계+동
		...
		<table id=zipcode>
			...
			<c:forEach items="${addressList}" var="addressVO">
				<tr>
					...
					<td><a href="#" onclick="result('${addressVO.zipNum}','${addressVO.sido}','${addressVO.gugun}','${addressVO.dong}')">
